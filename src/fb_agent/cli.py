...
def run() -> None:
    ...
    # Optional explicit agent URL to advertise to dashboard
    # Example: FB_AGENT_BASE_URL=http://100.88.90.36:8888
    agent_base_url = (os.environ.get("FB_AGENT_BASE_URL") or "").strip().rstrip("/")
