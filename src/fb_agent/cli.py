...
def run() -> None:
        ...
        try:
            ...
            try:
                ...
                for site_info in sites:
                    ...
                    if site:
                        stacks_dict.setdefault(stack, []).append(site)
    ...
    dashboard_url = dashboard_info.get("base_url") if isinstance(dashboard_info, dict) else None
                ...
                while True:
                    try:
                        ...
                        try:
                            ...
                            if resp.status_code == 200:
                                print("✓ Re-announced to dashboard", flush=True)
                        except Exception:
